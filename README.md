...
├── argocd-bootstrap/         # Root App-of-Apps manifest (Phase 2)
...
| **Phase 2** – GitOps | Install ArgoCD via Helm | ⏳ Pending |
| **Phase 3** – Core Services | ArgoCD deploys Traefik, Cert-Manager, ESO | ⏳ Pending |
